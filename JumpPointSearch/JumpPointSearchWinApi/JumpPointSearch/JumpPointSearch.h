...
private:
    ...
    //CList<JumpPointSearch::stNode*> mOpenList;
    std::list<stNode*> mOpenList;

    //CList<JumpPointSearch::stNode*> mCloseList;
    std::list<stNode*> mCloseList;


    //CList<JumpPointSearch::stNode*> mRouteList;
    std::list<stNode*> mRouteList;


    //CList<JumpPointSearch::stNode*> mOptimizeRouteList;
